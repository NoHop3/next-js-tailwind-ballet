      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Step into our world and witness the beauty of ballet in motion
          </p>
        </ScrollReveal>
              ...
              >
                <div>
                  ...
                  <p className="text-white/70">
                    Our students performing Swan Lake excerpts
                  </p>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16">
          {[
            { title: 'Professional Recording', desc: 'Captured in 4K quality' },
            { title: 'Student Performances', desc: 'Showcasing our talent' },
            { title: 'Behind the Scenes', desc: 'Studio life & rehearsals' },
          ].map((feature, i) => (
